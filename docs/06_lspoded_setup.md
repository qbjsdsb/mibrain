...
> - **LSPosed Vector 来源归属（第四轮 [F4](./14_feasibility_recheck_and_plan.md) 订正）**：当前活跃维护的 fork 位于 **`JingMatrix/Vector`** 仓库（非原 `LSPosed/LSPosed`）。Phase 1 下载 release 时以 `JingMatrix/Vector` 为准
...
⚠️ Phantom Mic v2.0 自 2024-07 发布至本次设计冻结（2026-06-30）已近 2 年未更新，**第四轮 web 核实 [F5](./14_feasibility_recheck_and_plan.md) 确认上游已停滞 23 个月**（自 2024-07-24 v2.0 后零更新）。Phase 1 已确认无新版本，需准备降级方案（appops + 双触发兜底 / WhatsMicFix 改造 / 放弃锁屏唤醒，详见 [D14](../DECISIONS.md)）。
...
| Phantom Mic 上游停滞 / HyperOS 3 不兼容 | 高 | **第四轮 web 核实 [F5](./14_feasibility_recheck_and_plan.md) 确认上游已停滞 23 个月**（自 2024-07-24 v2.0 后零更新，[D14](../DECISIONS.md)）；Phase 1 已确认无新版本，需验证降级方案（appops + 双触发兜底 / WhatsMicFix 改造 / 放弃锁屏唤醒）；Phase 4 真机验证为硬关卡 |
