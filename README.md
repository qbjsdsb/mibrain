...
> - **第五轮深度技术严谨性检查**：补强 11 项 ❌+⚠️ 技术细节（CMake/JNI/C API/KSU/sherpa-onnx/错误处理/状态机），详见 [15_technical_specs.md](./docs/15_technical_specs.md)（Phase 1 产出前必读）
> - 文档从 8 份扩展为 14 份编号文档（新增 Phase 6-10 共 5 份设计稿 + 第四轮 web 核实订正报告 14 + 第五轮技术规范补强 15），决策从 6 条扩为 **31 项已确认**（D1-D31） + 7 项已废弃（X1-X7，含 1 项重新评估）
...
- [13_phase10_ux_enhancements_design.md](./docs/13_phase10_ux_enhancements_design.md) — Phase 10 UX 增强（多用户/儿童/i18n/a11y/音频路由/全局暂停）

审查与技术规范：
- [14_feasibility_recheck_and_plan.md](./docs/14_feasibility_recheck_and_plan.md) — 第四轮 web 核实订正（F3-F7 修订记录）
- [15_technical_specs.md](./docs/15_technical_specs.md) — 技术规范补强（Phase 1 产出前必读，CMake/JNI/C API/KSU/sherpa-onnx/错误处理/状态机）
