...
- Phase 6：联网工具调用（联网开关 + 天气/翻译/搜索/新闻）— [设计草案](./docs/09_phase6_network_tools_design.md)
- Phase 7：手机控制（通知朗读/应用启动/系统设置/截屏看屏）— 待 brainstorm
- Phase 8：插件系统 + API 暴露 — 待 brainstorm
- Phase 9：多模态（OCR/看图/实时翻译）— 待 brainstorm
